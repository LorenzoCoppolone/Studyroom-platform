...
L’obiettivo principale è fornire un ambiente semplice e organizzato per:
- reperire materiale didattico affidabile
- condividere appunti
- consultare esami passati
...
- Visualizzare numero di download
...
- Rimuovere contenuti non appropriati
- Bannare utenti
...
Esempio valido:  
`nome.cognome@student.univaq.it`
...
- titolo
- file PDF
- tag (es: `riassunto`, `esercizi`, `formule`)
...
- creazione di discussioni su corsi, esami o materiali
- possibilità di rispondere ai messaggi
- sistema di moderazione
- segnalazione di messaggi offensivi
- ricerca di discussioni già aperte
